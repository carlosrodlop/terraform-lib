...
| <a name="input_name"></a> [name](#input\_name) | Platform Name. | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_eks_cluster_certificate_authority_data"></a> [eks\_cluster\_certificate\_authority\_data](#output\_eks\_cluster\_certificate\_authority\_data) | EKS cluster OIDC issuer URL |
